	...
	(0, _createClass3.default)(Editor, [{
		...
		value: function setOpts() {
			...
			var editorProps = (0, _extends3.default)({
				...
				// ],
				controls: ['undo', 'redo', 'split', 'font-size', 'text-color', 'bold', 'italic', 'underline', 'strike-through', 'superscript', 'subscript', 'text-align', 'split', 'headings', 'list_ul', 'list_ol', 'blockquote', 'split', 'link', 'split', 'media'],
				media: {
