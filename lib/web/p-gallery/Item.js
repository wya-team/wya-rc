...
var Item = function (_Component) {
	...
	function Item(props, context) {
		...
		_this.handleDel = function (e) {
			var _this$props = _this.props,
			    ...
			    cat_id = _this$props.pathSelect.cat_id;
		...
		_this.handleMove = function () {
			var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(e) {
				var inputCatId, _this$props2, _this$props2$itemData, file_id, file_name, paths, cat_id, itemData, PGallery, _ref8, _url, _ref9, url, request, param;
					...
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								inputCatId = void 0;
								_context2.prev = 1;
								_this$props2 = _this.props, _this$props2$itemData = _this$props2.itemData, file_id = _this$props2$itemData.file_id, file_name = _this$props2$itemData.file_name, paths = _this$props2.paths, cat_id = _this$props2.pathSelect.cat_id;
								_context2.next = 5;
								return new Promise(function (resolve, reject) {
									var memberRef = _modal2.default.confirm({
										title: _react2.default.createElement(
	...
	(0, _createClass3.default)(Item, [{
		...
		value: function render() {
			...
			var _ref11 = PGallery || {},
			    EXT_PGALLERY_IMG_SRC_SUF = _ref11.EXT_PGALLERY_IMG_SRC_SUF;

			return _react2.default.createElement(
				'div',
				{ className: '__item' },
				_react2.default.createElement('img', { src: '' + file_url + (EXT_PGALLERY_IMG_SRC_SUF || ''), alt: '', onClick: function onClick(e) {
						return _this3.props.onSelect(itemData);
					} }),
				selectArr.includes(file_id) && _react2.default.createElement(_icon2.default, { className: '__select', type: 'check-circle', onClick: function onClick(e) {
						return _this3.props.onSelect(itemData);
					} }),
				_react2.default.createElement(
					'div',
				...
				_react2.default.createElement(
					...
					cat_id != 0 && _react2.default.createElement(
						'div',
						{
