...
var PGallery = (_temp = _class = function (_Component) {
	...
	function PGallery(props, context) {
		...
		_this.setGallery = function (node) {
			_this.gallery = node;
		};
		...
		_this.handleClose = function (e) {
			...
			_this.gallery.classList.remove('__active');
		...
		_this.handleSure = function (id) {

			_this.gallery.classList.remove('__active');
			_this.timer = setTimeout(function () {
				_this.props.onSure && _this.props.onSure(id);
			}, 201);
		};
	...
	(0, _createClass3.default)(PGallery, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'wp-gallery', ref: this.setGallery },
				_react2.default.createElement('div', { className: '__mask', onClick: this.handleClose }),
				_react2.default.createElement(
					'div',
					{ className: '__container' },
					_react2.default.createElement(_Header2.default, { onClose: this.handleClose }),
					_react2.default.createElement(
						'div',
